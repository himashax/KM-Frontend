...
class Inventory extends Component {
  ...
  handleSubmitFile = (e) => {
    e.preventDefault()
        ...
        axios({
          method: "POST",
          url: 'http://localhost:8081/items/files/uploadItems',
          data: formData,
  ...
  fetchDocuments(){
    fetch('http://localhost:8081/items/files/itemFilesList')
  ...
  deleteDocuement = (id) => {
    console.log(id)
    var url= 'http://localhost:8081/items/files/itemFile/' + id + "/"
    fetch(url, {
        method:'DELETE',
        headers:{
  ...
  handleUpdateFile = (e, document) => {
    ...
    console.log('updated selected doc', document)
        ...
        axios({
          method: 'PATCH',
          url: 'http://localhost:8081/items/files/uploadItemsitemFile' + id + '/',
  ...
  onSearch = (name) => {
    var url= 'http://localhost:8081/items/files/file/name/' + name
    axios(url)
        .then((response) => {
        console.log(url)
        this.setState({
