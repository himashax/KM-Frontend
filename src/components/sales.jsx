...
class Sales extends Component {
  ...
  handleSubmitFile = (e) => {
    e.preventDefault()
        ...
        axios({
          method: "POST",
          url: 'http://localhost:8081/sales/files/upload',
          data: formData,
  ...
  fetchDocuments(){
    fetch('http://localhost:8081/sales/files/filesList')
  ...
  deleteDocuement = (id) => {
    console.log(id)
    var url= 'http://localhost:8081/sales/files/file/' + id + "/"
    fetch(url, {
        method:'DELETE',
        headers:{
  ...
  handleUpdateFile = (e, document) => {
    ...
    console.log('updated selected doc', document)
        ...
        axios({
          method: 'PATCH',
          url: 'http://localhost:8081/sales/files/file/' + id + '/',
  ...
  onSearch = (name) => {
    var url= 'http://localhost:8081/sales/files/file/name/' + name
    axios(url)
        .then((response) => {
        console.log(url)
        this.setState({
