...
class OrderDelivery extends Component {
  ...
  handleSubmitFile = (e) => {
    e.preventDefault()
        ...
        axios({
          method: "POST",
          url: 'http://localhost:8081/orderDelivery/files/uploadOrderDeliveryFiles',
          data: formData,
  ...
  fetchDocuments(){
    fetch('http://localhost:8081/orderDelivery/files/orderDeliveryFilesList')
  ...
  deleteDocuement = (id) => {
    console.log(id)
    var url= 'http://localhost:8081/orderDelivery/files/orderDeliveryFile/' + id + "/"
    fetch(url, {
        method:'DELETE',
        headers:{
  ...
  handleUpdateFile = (e, document) => {
    ...
    console.log('updated selected doc', document)
        ...
        axios({
          method: 'PATCH',
          url: 'http://localhost:8081/orderDelivery/files/orderDeliveryFile/' + id + '/',
  ...
  onSearch = (name) => {
    var url= 'http://localhost:8081/orderDelivery/files/file/name/' + name
    axios(url)
        .then((response) => {
        console.log(url)
        this.setState({
